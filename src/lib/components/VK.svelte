...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 256 256" {width} {height} {...rest}
	><g clip-path="url(#prefix__a)"
		><mask
			...
			style="mask-type:luminance"><path fill="#fff" d="M256 0H0v256h256V0z" /></mask
		><g mask="url(#prefix__a)"
			...
			/></g
		></g
	><defs><clipPath id="prefix__a"><path fill="#fff" d="M0 0h256v256H0z" /></clipPath></defs></svg
>
