...
<svg
	...
	><defs
		><linearGradient id="a" x1="42.173%" x2="57.827%" y1=".584%" y2="99.416%"
			><stop offset="1%" stop-color="#00B7F0" /><stop offset="34%" stop-color="#009DE5" /><stop
				offset="76%"
				stop-color="#0082D9"
			/><stop offset="100%" stop-color="#0078D4" /></linearGradient
		><linearGradient id="b" x1="6.659%" x2="93.341%" y1="75%" y2="25%"
			><stop offset="0%" stop-color="#0078D4" /><stop offset="37%" stop-color="#007AD5" /><stop
				offset="57%"
				stop-color="#0082D9"
			/><stop offset="74%" stop-color="#0090DF" /><stop offset="88%" stop-color="#00A3E7" /><stop
				offset="100%"
				stop-color="#00BCF2"
			/></linearGradient
		...
		><radialGradient id="d" cx="48.539%" cy="50%" r="50.021%" fx="48.539%" fy="50%"
			><stop offset="0%" /><stop offset="100%" stop-opacity="0" /></radialGradient
		><path
			id="c"
	...
	/><circle cx="75.994" cy="76.171" r="75.893" fill="url(#a)" /><circle
		cx="179.903"
		cy="180.08"
		r="75.893"
		fill="url(#b)"
	/><mask id="e" fill="#fff"><use xlink:href="#c" /></mask><circle
		cx="125.547"
		cy="133.578"
		r="141.812"
		fill="url(#d)"
		mask="url(#e)"
	/><circle cx="127.948" cy="128.125" r="119.868" fill="url(#f)" /><circle
		cx="127.948"
		cy="128.125"
		r="119.868"
		fill="url(#g)"
