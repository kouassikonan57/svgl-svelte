...
<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 128 128" {...rest}
	><linearGradient
		id="a"
		x1="96.306"
		x2="25.454"
	...
	/><linearGradient
		...
		gradientTransform="matrix(1 0 0 -1 0 128)"
		gradientUnits="userSpaceOnUse"
		><stop offset="0" stop-color="#2d4664" /><stop offset=".169" stop-color="#29405b" /><stop
			offset=".445"
			stop-color="#1e2f43"
		/><stop offset=".79" stop-color="#0c131b" /><stop offset="1" /></linearGradient
	><path
		fill="url(#b)"
		fill-rule="evenodd"
