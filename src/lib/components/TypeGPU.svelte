...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 166 166" fill="none" {width} {height} {...rest}
	><path
		fill="url(#a)"
	...
	/><defs
		><linearGradient
			...
			><stop offset=".4" stop-color="#D48DFF" /><stop offset=".6" stop-color="#6C80FF" /><stop
				offset=".9"
				stop-color="#0059DF"
			/></linearGradient
		><linearGradient
			...
			y2="197.7"
			gradientUnits="userSpaceOnUse"
			><stop offset=".3" stop-color="#D48DFF" /><stop
				offset=".8"
				stop-color="#273DE6"
			/></linearGradient
		></defs
