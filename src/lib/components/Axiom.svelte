...
<svg viewBox="0 0 358 309" xmlns="http://www.w3.org/2000/svg" fill="none" {width} {height} {...rest}
	><g clip-path="url(#a)"
		><path
			fill="#000"
		...
		/></g
	><defs><clipPath id="a"><path fill="#fff" d="M0 0h358v309H0z" /></clipPath></defs></svg
>
