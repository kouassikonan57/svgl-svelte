...
<svg
	...
	{...rest}
	><defs
		><path d="M4.883.09v1.08a1 1 0 01-1 1H1a1 1 0 01-1-1V.09h4.883z" id="a" /><path
			d="M4.883.09v1.08a1 1 0 01-1 1H1a1 1 0 01-1-1V.09h4.883z"
			id="b"
		/></defs
	><g fill="none" fill-rule="evenodd"
		><path fill="#FFF" d="M99 52h84v34H99z" /><path
		...
		/><path
			...
			fill="#3ECC5F"
		/><path fill="#3ECC5F" d="M143 183h30v-40h-30z" /><path
			...
			fill="#44D860"
		/><path fill="#3ECC5F" d="M153 123h30v-20h-30z" /><path
		...
		/><path
			...
			fill="#000"
		/><path fill="#3ECC5F" d="M83 183h40v-40H83z" /><g transform="rotate(-15 433.487 -340.892)"
			><rect fill="#D8D8D8" x=".046" y=".014" width="84.522" height="33.367" rx="2" /><g
				transform="translate(1 20.75)"
				fill="#4A4A4A"
				><rect x="15.818" y=".339" width="4.883" height="4.883" rx="1" /><rect
					x="21.605"
					y=".339"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="27.392" y=".339" width="4.883" height="4.883" rx="1" /><rect
					x="33.179"
					y=".339"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="38.966" y=".339" width="4.883" height="4.883" rx="1" /><rect
					x="44.753"
					y=".339"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="50.54" y=".339" width="4.883" height="4.883" rx="1" /><rect
					x="56.327"
					y=".339"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="62.114" y=".339" width="4.883" height="4.883" rx="1" /><path
			...
			><g transform="translate(1 9)" fill="#4A4A4A"
				...
				/><rect x="8.042" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="13.829"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="19.616" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="25.403"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="31.19" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="36.977"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="42.764" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="48.551"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="54.337" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="60.124"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="65.911" y=".404" width="4.883" height="4.883" rx="1" /><rect
					x="71.698"
					y=".404"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="77.485" y=".404" width="4.883" height="4.883" rx="1" /></g
			><g transform="rotate(-180 41.684 4.375)" fill="#4A4A4A"
				><path d="M1 0h4.691a1 1 0 011 1v2.883a1 1 0 01-1 1H1a1 1 0 01-1-1V1a1 1 0 011-1z" /><rect
					x="7.595"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="13.382" width="4.883" height="4.883" rx="1" /><rect
					x="19.169"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="24.956" width="4.883" height="4.883" rx="1" /><rect
					x="30.743"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="36.53" width="4.883" height="4.883" rx="1" /><rect
					x="42.317"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="48.104" width="4.883" height="4.883" rx="1" /><rect
					x="53.891"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="59.678" width="4.883" height="4.883" rx="1" /><rect
					x="65.465"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="71.252" width="4.883" height="4.883" rx="1" /><rect
					x="77.038"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="7.595" width="4.883" height="4.883" rx="1" /><rect
					x="13.382"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="19.169" width="4.883" height="4.883" rx="1" /><rect
					x="24.956"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="30.743" width="4.883" height="4.883" rx="1" /><rect
					x="36.53"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="42.317" width="4.883" height="4.883" rx="1" /><rect
					x="48.104"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="53.891" width="4.883" height="4.883" rx="1" /><rect
					x="59.678"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="65.465" width="4.883" height="4.883" rx="1" /><rect
					x="71.252"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="77.038" width="4.883" height="4.883" rx="1" /></g
			><g fill="#4A4A4A"
				><path
				...
				/><g transform="translate(11.212 15.19)"
					><rect width="4.883" height="4.883" rx="1" /><rect
						x="5.787"
						width="4.883"
						height="4.883"
						rx="1"
					/><rect x="11.574" width="4.883" height="4.883" rx="1" /><rect
						x="17.361"
						width="4.883"
						height="4.883"
						rx="1"
					/><rect x="23.148" width="4.883" height="4.883" rx="1" /><rect
						x="28.935"
						width="4.883"
						height="4.883"
						rx="1"
					/><rect x="34.722" width="4.883" height="4.883" rx="1" /><rect
						x="40.508"
						width="4.883"
						height="4.883"
						rx="1"
					/><rect x="46.295" width="4.883" height="4.883" rx="1" /><rect
						x="52.082"
						width="4.883"
						height="4.883"
						rx="1"
					/><rect x="57.869" width="4.883" height="4.883" rx="1" /></g
				><path
			...
			><g transform="translate(1 26)" fill="#4A4A4A"
				><rect x=".447" y="1.126" width="4.883" height="4.883" rx="1" /><rect
					x="6.234"
					y="1.126"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="12.021" y="1.126" width="4.883" height="4.883" rx="1" /><rect
					x="17.808"
					y="1.126"
					width="4.883"
					height="4.883"
				...
				/><rect x="60.848" y="1.126" width="4.883" height="4.883" rx="1" /><rect
					x="66.635"
					y="1.126"
					width="4.883"
					height="4.883"
					rx="1"
				/><rect x="77.485" y="1.126" width="4.883" height="4.883" rx="1" /><use
					xlink:href="#a"
					transform="rotate(-180 38.471 1.648)"
				/><use xlink:href="#b" transform="translate(72.06 3.839)" /></g
			><rect fill="#4A4A4A" x="1.808" y="1.085" width="81.379" height="2.17" rx="1.085" /><rect
				fill="#D8D8D8"
				opacity=".136"
				x="3.798"
				y="1.447"
		...
		><path
			...
			fill="#44D860"
		/><path fill="#3ECC5F" d="M83 123h40v-20H83z" /><path
