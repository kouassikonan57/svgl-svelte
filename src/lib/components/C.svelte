...
<svg viewBox="0 0 306 345" xmlns="http://www.w3.org/2000/svg" fill="none" {width} {height} {...rest}
	><g clip-path="url(#a)"
		><path
			fill="#00599C"
		...
		/></g
	><defs><clipPath id="a"><path fill="#fff" d="M0 0h306v344.35H0z" /></clipPath></defs></svg
>
