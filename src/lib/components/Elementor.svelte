...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" fill="none" {width} {height} {...rest}
	><g clip-path="url(#clip0)"
		><path
			...
			fill="#92003B"
		></path></g
	><defs><clipPath id="clip0"><rect width="400" height="400" fill="white"></rect></clipPath></defs
	></svg
>
