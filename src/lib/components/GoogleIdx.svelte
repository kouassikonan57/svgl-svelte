<script lang="ts">
	...
	const svgContent = `<svg viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-8" width="${width}" height="${height}"> <rect x="28" y="156" width="88" height="24" rx="12" fill="#8964e8">
