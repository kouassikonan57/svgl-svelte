...
>
	...
	<use
		xlink:href="#b"
		fill="#627eea"
		style="display:inline;fill:#e5e5e5;fill-opacity:1;fill-rule:evenodd"
	/>
	<use
		xlink:href="#b"
		fill="url(#c)"
		style="display:inline;mix-blend-mode:soft-light;fill:url(#c);fill-rule:evenodd"
	/>
	<circle
		cx="16"
		cy="15"
	...
	<path
		...
		style="fill:#000;fill-opacity:1;stroke:none;stroke-width:.141594;stroke-opacity:1"
	/>
</svg>
