...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100" {width} {height} {...rest}
	...
	><defs
		><filter
			...
			/><feBlend in2="BackgroundImageFix" mode="overlay" result="effect1_dropShadow" /><feBlend
				in="SourceGraphic"
