...
<svg
	...
	{...rest}
	><title>icon/xrp</title><desc>Created with Sketch.</desc><defs
		><linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-1"
			><stop stop-color="#FFF" stop-opacity=".5" offset="0%" /><stop
				...
				offset="100%"
			/></linearGradient
		><circle id="path-2" cx="15" cy="15" r="15" /><filter
			x="-5.8%"
			y="-4.2%"
			width="111.7%"
			height="111.7%"
			...
			id="filter-3"
			><feOffset dx="0" dy=".5" in="SourceAlpha" result="shadowOffsetOuter1" /><feGaussianBlur
				stdDeviation=".5"
	...
	><g id="icon/xrp" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
		><g id="Group" transform="translate(1.000000, 0.000000)" fill-rule="nonzero"
			><g id="Oval"
				><use fill="#000" fill-opacity="1" filter="url(#filter-3)" xlink:href="#path-2" /><use
					fill="#23292F"
					fill-rule="evenodd"
					xlink:href="#path-2"
				/><use
				...
				/></g
			></g
		><g id="XRP-(XRP)" transform="translate(7.000000, 8.000000)" fill="#FFF" fill-rule="nonzero"
			><path
