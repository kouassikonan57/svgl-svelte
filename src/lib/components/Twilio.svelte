...
<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {width} {height} {...rest}
	><g transform="translate(0 .047) scale(.93704)" fill="#e31e26"
		...
		/><circle cx="42.6" cy="25.6" r="7.1" /><circle cx="42.6" cy="42.6" r="7.1" /><circle
			cx="25.6"
			cy="42.6"
			r="7.1"
		/><circle cx="25.6" cy="25.6" r="7.1" /></g
	></svg
>
