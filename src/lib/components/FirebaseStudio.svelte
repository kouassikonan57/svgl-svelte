...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.5 65" {width} {height} {...rest}
	><defs
		><linearGradient
			id="b"
			x1="5.9"
			...
			><stop offset="0" stop-color="#f8682f" /><stop
				offset="1"
				stop-color="#dd2c00"
			/></linearGradient
		><linearGradient
			...
			gradientTransform="matrix(1 0 0 -1 0 66)"
			gradientUnits="userSpaceOnUse"
			><stop offset="0" stop-color="#f8682f" /><stop offset=".6" stop-color="#e92a4e" /><stop
				offset="1"
				stop-color="#c447ff"
			/></linearGradient
		><clipPath id="a"><path d="M0 .1h44.8v64H0z" style="fill:none" /></clipPath></defs
