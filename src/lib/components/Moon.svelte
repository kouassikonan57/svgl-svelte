<script lang="ts">
	...
	const svgContent = `
<svg viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="${width}" height="${height}">
    <title>Moon</title>
    <defs>
