...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 276 276" {width} {height} {...rest}
	><rect width="274" height="274" x="1" y="1" fill="url(#a)" rx="81" /><path
		stroke="url(#b)"
	...
	/><rect width="274" height="274" x="1" y="1" stroke="url(#c)" stroke-width="2" rx="81" /><defs
		><linearGradient id="a" x1="2" x2="274" y1="2" y2="274" gradientUnits="userSpaceOnUse"
			><stop stop-color="#9688FD" /><stop offset="1" stop-color="#607EF4" /></linearGradient
		><linearGradient
			id="b"
			x1="132.555"
			x2="94.765"
			...
			><stop stop-color="#F4F3FF" /><stop offset="1" stop-color="#D7D5FF" /></linearGradient
