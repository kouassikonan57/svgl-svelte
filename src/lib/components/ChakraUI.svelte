...
<svg viewBox="0 0 257 257" xmlns="http://www.w3.org/2000/svg" {width} {height} {...rest}
	><rect width="257" height="257" rx="128.5" fill="url(#a)" /><path
	...
	/><defs
		><linearGradient id="a" x1="128.5" x2="128.5" y2="257" gradientUnits="userSpaceOnUse"
			><stop stop-color="#7BCBD4" /><stop offset="1" stop-color="#29C6B7" /></linearGradient
		></defs
	></svg
>
