...
<svg
	...
	><defs
		><linearGradient id="doge-c" x1="50%" x2="50%" y1="0%" y2="100%"
			><stop offset="0%" stop-color="#FFF" stop-opacity=".5" /><stop
				...
				stop-opacity=".5"
			/></linearGradient
		><circle id="doge-b" cx="16" cy="15" r="15" /><filter
			id="doge-a"
			width="111.7%"
			height="111.7%"
			x="-5.8%"
	...
	><g fill="none" fill-rule="evenodd"
		><use fill="#000" filter="url(#doge-a)" xlink:href="#doge-b" /><use
			fill="#C3A634"
			xlink:href="#doge-b"
		/><use fill="url(#doge-c)" style="mix-blend-mode:soft-light" xlink:href="#doge-b" /><circle
			cx="16"
			cy="15"
			r="14.5"
			stroke="#000"
			stroke-opacity=".097"
		/><g
			><use fill="#000" filter="url(#doge-d)" xlink:href="#doge-e" /><use
				fill="#FFF"
				xlink:href="#doge-e"
			/></g
		></g
