...
<svg
	...
	><defs
		><linearGradient id="btc-c" x1="50%" x2="50%" y1="0%" y2="100%"
			><stop offset="0%" stop-color="#FFF" stop-opacity=".5" /><stop
				...
				stop-opacity=".5"
			/></linearGradient
		><circle id="btc-b" cx="16" cy="15" r="15" /><filter
			id="btc-a"
			width="111.7%"
			height="111.7%"
			x="-5.8%"
	...
	><g fill="none" fill-rule="evenodd"
		><use fill="#000" filter="url(#btc-a)" xlink:href="#btc-b" /><use
			fill="#F7931A"
			xlink:href="#btc-b"
		/><use fill="url(#btc-c)" style="mix-blend-mode:soft-light" xlink:href="#btc-b" /><circle
			cx="16"
			cy="15"
			r="14.5"
			stroke="#000"
			stroke-opacity=".097"
		/><g fill-rule="nonzero"
			><use fill="#000" filter="url(#btc-d)" xlink:href="#btc-e" /><use
				fill="#FFF"
				fill-rule="evenodd"
				xlink:href="#btc-e"
			/></g
