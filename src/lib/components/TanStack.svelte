...
<svg
	...
	><defs
		><linearGradient id="b" x1="50%" x2="50%" y1="0%" y2="71.65%"
			><stop offset="0%" stop-color="#6BDAFF" /><stop offset="31.922%" stop-color="#F9FFB5" /><stop
				offset="70.627%"
				stop-color="#FFA770"
			/><stop offset="100%" stop-color="#FF7373" /></linearGradient
		><linearGradient id="d" x1="43.996%" x2="53.441%" y1="8.54%" y2="93.872%"
			><stop offset="0%" stop-color="#673800" /><stop
				offset="100%"
				stop-color="#B65E00"
			/></linearGradient
	...
	><g fill="none" fill-rule="evenodd" transform="translate(9 8)"
		><mask id="c" fill="#fff"><use xlink:href="#a" /></mask><use
			xlink:href="#a"
			fill="url(#b)"
		/><ellipse
			cx="81.5"
		...
		/><g mask="url(#c)"
			...
			/></g
		><ellipse cx="308.5" cy="720.5" fill="url(#l)" mask="url(#c)" rx="266" ry="316.5" /><ellipse
			cx="308.5"
			cy="720.5"
			stroke="#6DA300"
			stroke-opacity=".502"
		...
		/><g mask="url(#c)"
			><g transform="translate(389 -32)"
				...
				/></g
			></g
		><circle cx="307.5" cy="308.5" r="304" stroke="#000" stroke-width="25" /></g
	></svg
>
