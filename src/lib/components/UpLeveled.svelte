...
<svg viewBox="0 0 154 154" xmlns="http://www.w3.org/2000/svg" {width} {height} {...rest}
	><defs
		><linearGradient id="a" y2="99.879%" x2="100%" y1=".121%" x1="0%"
			><stop offset="0%" stop-color="#FF3367" /><stop offset="26.795%" stop-color="#FF3393" /><stop
				offset="100%"
				stop-color="#844FFF"
			/></linearGradient
		><linearGradient id="b" y2="99.875%" x2="100%" y1=".125%" x1="0%"
			...
			/></linearGradient
		></defs
	><path fill="none" d="M-1-1h156v156H-1z" /><path
		fill="url(#a)"
		d="M8.545 145.455h130.169v9.09H-.545V15.455h9.09z"
	/><path fill="url(#b)" d="M17.653 0h136.535v136.364H17.653z" /><path
		fill="#FFF"
