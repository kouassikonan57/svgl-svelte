...
<svg
	...
	><defs
		><radialGradient
			...
			><stop stop-color="#6447FF" /><stop offset=".067" stop-color="#6348FE" /><stop
				offset=".133"
				stop-color="#614DFC"
			/><stop offset=".2" stop-color="#5C54F8" /><stop offset=".267" stop-color="#565EF3" /><stop
				offset=".333"
				stop-color="#4E6CEC"
			/><stop offset=".4" stop-color="#447BE4" /><stop offset=".467" stop-color="#3A8DDB" /><stop
				offset=".533"
				stop-color="#2F9FD1"
			/><stop offset=".6" stop-color="#25B1C8" /><stop offset=".667" stop-color="#1BC0C0" /><stop
				offset=".733"
				stop-color="#13CEB9"
			/><stop offset=".8" stop-color="#0DD8B4" /><stop offset=".867" stop-color="#08DFB0" /><stop
				offset=".933"
				stop-color="#06E4AE"
			/><stop offset="1" stop-color="#05E5AD" /></radialGradient
		><radialGradient
			id="b"
			cx="0"
			cy="0"
		...
		><radialGradient
			...
			><stop stop-color="#05E5AD" /><stop offset=".32" stop-color="#05E5AD" stop-opacity="0" /><stop
				offset=".903"
				stop-color="#6447FF"
			/></radialGradient
		></defs
