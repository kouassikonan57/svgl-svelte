...
<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 192 192" {...rest}
	><path fill="none" d="M0 0h192v192H0z" /><circle cx="96" cy="96" r="88" fill="red" /><path
		fill="#FFF"
	...
	/><path fill="#FFF" d="m79 122 45-26-45-26z" /></svg
>
