...
<svg
	...
	><defs
		><linearGradient id="eth-c" x1="50%" x2="50%" y1="0%" y2="100%"
			><stop offset="0%" stop-color="#FFF" stop-opacity=".5" /><stop
				...
				stop-opacity=".5"
			/></linearGradient
		><circle id="eth-b" cx="16" cy="15" r="15" /><filter
			id="eth-a"
			width="111.7%"
			height="111.7%"
			x="-5.8%"
	...
	><g fill="none" fill-rule="evenodd"
		><use fill="#000" filter="url(#eth-a)" xlink:href="#eth-b" /><use
			fill="#627EEA"
			xlink:href="#eth-b"
		/><use fill="url(#eth-c)" style="mix-blend-mode:soft-light" xlink:href="#eth-b" /><circle
			cx="16"
			cy="15"
			r="14.5"
			stroke="#000"
			stroke-opacity=".097"
		/><g fill-rule="nonzero"
			><use fill="#000" filter="url(#eth-d)" xlink:href="#eth-e" /><use
				fill="#FFF"
				fill-opacity="0"
				fill-rule="evenodd"
				xlink:href="#eth-e"
		...
		><g fill="#FFF" fill-rule="nonzero" transform="translate(9 3)"
			><polygon fill-opacity=".602" points="7.498 0 7.498 8.87 14.995 12.22" /><polygon
				points="7.498 0 0 12.22 7.498 8.87"
			/><polygon fill-opacity=".602" points="7.498 17.968 7.498 23.995 15 13.616" /><polygon
				points="7.498 23.995 7.498 17.967 0 13.616"
			/><polygon fill-opacity=".2" points="7.498 16.573 14.995 12.22 7.498 8.872" /><polygon
				fill-opacity=".602"
